        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                <div className="flex md:justify-between">
                    ...
                    <div className="flex justify-between" style={{width: '100%',flexWrap:'wrap'}}>
                        ...
                        <div className="mx-4 my-4">
                            ...
                            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" / >
                            <ul className="text-gray-600 dark:text-gray-400 ">
                                <li className="mb-4 flex dark:hover:text-white">
                                <a href="info@professionbeat.com" className="hover:underline hover:text-gray-900 dark:hover:text-white"><svg className="w-5 h-5 icons mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"/></svg></a>
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 md:mt-4">
                            <a href="https://www.facebook.com/Professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://www.instagram.com/professionbeat/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://twitter.com/professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://www.linkedin.com/company/professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://www.youtube.com/channel/UCxh25EWiXPBuqjIKiOe6-WQ" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" style={{color:"#FE0100", hover:"color:white"}}>
