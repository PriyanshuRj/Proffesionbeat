        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-100">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 md:mt-4">
                            <a href="https://www.facebook.com/Professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800">
                            ...
                            <a href="https://www.instagram.com/professionbeat/" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800">
                            ...
                            <a href="https://twitter.com/professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800">
                            ...
                            <a href="https://www.linkedin.com/company/professionbeat" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800">
                            ...
                            <a href="https://www.youtube.com/channel/UCxh25EWiXPBuqjIKiOe6-WQ" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800" style={{color:"#FE0100", hover:"color:white"}}>
