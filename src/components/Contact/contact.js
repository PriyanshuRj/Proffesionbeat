...
export default function Contact() {
  return (
    <div className="bg-gray-100 text-gray-900 md:p-10">
        <h1 className="text-5xl text-center text-indigo-600 font-bold">Contact</h1>
     <div className=" flex flex-col md:flex-row  items-center justify-center md:justify-around md:m-10 lg:m-20 ">
<div className="flex flex-col justify-center items-center rounded bg-gray-200 md:w-2/5 px-10 py-10 hover:bg-gray-400 ease-out duration-300 my-10 md:my-0">
<FontAwesomeIcon icon={faPhone} className=" h-20 w-20 "/>
<span className="text-2xl font-bold mt-4">Call Us</span>
<a href="tel:9653007853">Phone :+91 9653007853</a>
</div>
<div className="flex flex-col justify-center items-center rounded bg-gray-200 md:w-2/5 px-10 py-10 hover:bg-gray-400 ease-out duration-300">
<FontAwesomeIcon icon={faEnvelope} className=" h-20 w-20 "/>
<span className="text-2xl font-bold mt-4">Email</span>
<a href="mailto:info@professionbeat.com">info@professionbeat.com</a>
</div>
     </div>
      <div
        class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  rounded-lg shadow-lg">
        <div class="flex flex-col justify-between ">
          <div>
            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Drop us a message for any query</h2>
